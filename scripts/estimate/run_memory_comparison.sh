...
LOG_FILE="$OUTPUT_DIR/memory_comparison_$TIMESTAMP.log"
...
================================================================================
                    FSDP Memory Estimation vs Actual Usage Comparison
================================================================================
EOF
...
PYTHON_CMD="python scripts/estimate/compare_memory_usage.py"
...
run_and_log "$FULL_CMD" "Memory Comparison Analysis"

# Find and display the generated JSON report
log_with_timestamp "=== Generated Files ==="
JSON_FILES=$(find "$OUTPUT_DIR" -name "memory_comparison_*.json" -newer "$LOG_FILE" 2>/dev/null || true)
...
If JSON files were generated, you can also examine them directly.
================================================================================
EOF
